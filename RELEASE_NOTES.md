...
SnipCue 是一款 macOS 菜单栏截图工具，支持截图、滚动截屏、标注、文字提取与翻译。

## 下载与安装

下载附件 `SnipCue-0.1.1-macos-arm64.dmg`，打开镜像，把 `SnipCue.app` 拖到“应用程序”，等待复制完成后弹出镜像，再从“应用程序”打开。支持 **macOS 15 或更新版本、Apple 芯片**；本次没有 Intel 版。
...
DMG SHA-256：`424b4d9dce76c7cddfd353156243388b85ec20e0f1e8cc60fbfa356d4ba2c60f`
